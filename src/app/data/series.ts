...
export const SeriesList: Series[] = [
    ...
    {id: '036', level: 110, name: '魔候爵', noPartsList: ['2'], job: ['00', '07', '08', '19'], exEffect: '味方死亡時20%でバイシオン 瀕死時15%攻撃力+60 (試合無効) ブレス系ダメージ8%減'},
    ...
    {id: '041', level: 115, name: '蒼穹兵団', noPartsList: [], job: ['00', '07', '08', '19'], exEffect: 'さいだいHP+20 特技のダメージ+10(試合無効) 行動時5.0%でバイシオンとスカラ 会心完全ガード+5%'},
    ...
    {id: '046', level: 118, name: 'ほのお', noPartsList: [], job: ['00', '07', '08', '19'], exEffect: 'さいだいHP+22 氷ダメージ20%減 炎の攻撃ダメージ+5% 行動時5%でテンションアップ'},
