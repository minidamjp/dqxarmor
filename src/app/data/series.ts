...
export const SeriesList: Series[] = [
    ...
    {id: '039', level: 110, name: 'グレイスフル', noPartsList: [], job: ['05,09,11,14,17'], exEffect: 'コマンド間隔-0.5秒 状態異常系の成功率 +10% 攻撃呪文ダメージ5%減'},
    {id: '040', level: 110, name: '妖炎魔女', noPartsList: ['3'], job: ['01,02,10,15,16,18'], exEffect: '炎・闇の攻撃ダメージ+5% 2.0%でターン消費なし (試合無効) 会心率と呪文暴走率+1.0%'},
