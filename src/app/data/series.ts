...
export const SeriesList: Series[] = [
    {id: '001', level: 90, name: '大戦鬼', noPartsList: ['2'], job: ['00', '07', '08', '19', '21'], exEffect: '開戦時50％で攻撃力+60 仲間が死んだら50％でためる'},
    ...
    {id: '006', level: 93, name: '降魔', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '攻撃呪文ダメージ7%減 受けた属性ダメージの10%回復(フォース無効)'},
    ...
    {id: '011', level: 96, name: '鉄壁', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '被ダメージ10軽減'},
    ...
    {id: '016', level: 99, name: 'シュバリエ', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '特技のダメージ+10（試合無効） 開戦時50％で聖騎士の堅陣'},
    ...
    {id: '021', level: 100, name: 'ヴァルハラ', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '仲間死亡時50％でためる(試合無効) 会心完全ガード+5％'},
    ...
    {id: '026', level: 105, name: 'ネヴァン', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '敵を倒すと5%でバイシオン 復活時ヘヴィチャージ+25%'},
    ...
    {id: '031', level: 108, name: 'ミラー', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: '行動時10%でマホターン 受けるダメージ10軽減'},
    ...
    {id: '036', level: 110, name: '魔候爵', noPartsList: ['2'], job: ['00', '07', '08', '19', '21'], exEffect: '味方死亡時20%でバイシオン 瀕死時15%攻撃力+60 (試合無効) ブレス系ダメージ8%減'},
    {id: '037', level: 110, name: 'ファフニル', noPartsList: [], job: ['03', '06', '12', '14'], exEffect: '特技のダメージ+15 (試合無効) 行動時5.0%でバイシオンとピオラ 3.0%でターン消費なし (試合無効)'},
    {id: '038', level: 110, name: 'ワンダラーズ', noPartsList: ['2'], job: ['04', '08', '13', '20'], exEffect: '開戦時100%で早詠みの杖 行動時5.0%で早詠みの杖 必殺チャージ率+1%'},
    ...
    {id: '041', level: 115, name: '蒼穹兵団', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: 'さいだいHP+20 特技のダメージ+10(試合無効) 行動時5.0%でバイシオンとスカラ 会心完全ガード+5%'},
    {id: '042', level: 115, name: '聖域', noPartsList: [], job: ['03', '06', '12', '14'], exEffect: 'さいだいHP+15 こうげき力+8 コマンド間隔-0.5秒 攻撃時5.0%でチャージ時間-10秒 身かわし率+3.0%'},
    {id: '043', level: 115, name: '空賊', noPartsList: [], job: ['04', '08', '13', '20'], exEffect: 'さいだいHP+12 きようさ+70 行動時20.0%でバイシオン 状態異常系の成功率 +10% 必殺チャージ率+1%'},
    {id: '044', level: 115, name: '聖翼', noPartsList: [], job: ['05', '09', '11', '14', '17'], exEffect: 'さいだいHP+12 さいだいMP+10 行動時2.0%で聖女の守り(試合無効) 攻撃呪文ダメージ7%減 攻撃時5.0%チャージ時間-10秒'},
    {id: '045', level: 115, name: 'ロードリー', noPartsList: [], job: ['01', '02', '10', '15', '16', '18'], exEffect: 'さいだいHP+10 さいだいMP+15 ブレス系ダメージ10%減 攻撃呪文ダメージ7%減 呪文発動速度+2%'},

    {id: '046', level: 118, name: 'ほのお', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: 'さいだいHP+22 氷ダメージ20%減 炎の攻撃ダメージ+5% 行動時5%でテンションアップ'},
    {id: '047', level: 118, name: '天の冒険者', noPartsList: ['0'], job: ['03', '06', '12', '14'], exEffect: 'さいだいHP+16 こうげき力+9 行動時5.0%でバイキルト 会心率と呪文暴走率+1.5% 会心と暴走時魔物にダメージ+100'},
    {id: '048', level: 118, name: 'しっこく', noPartsList: ['2'], job: ['04', '08', '13', '20'], exEffect: 'さいだいHP+14 きようさ+75 コマンド間隔-0.5秒 必殺チャージ率+1% 必殺チャージ時 身かわし+10%'},
    {id: '049', level: 118, name: 'スパングル', noPartsList: [], job: ['05', '09', '11', '14', '17'], exEffect: 'さいだいHP+13 さいだいMP+11 特技のダメージ+20(試合無効) 呪文発動速度+2% 必殺チャージ率+1%'},
    {id: '050', level: 118, name: 'ふしぎ', noPartsList: [], job: ['01', '02', '10', '15', '16', '18'], exEffect: 'さいだいHP+10 さいだいMP+16 戦闘時常時マホトラのころも 全ての属性ダメージ+3.0% 2.0%でターン消費なし(試合無効)'},

    {id: '051', level: 120, name: '魔衛隊士', noPartsList: [], job: ['00', '07', '08', '19', '21'], exEffect: 'さいだいHP+24 必殺チャージ率+1% 攻撃呪文ダメージ5%減 受けた属性ダメージの10%HP回復(フォース無効・試合無効)'},
    {id: '052', level: 120, name: 'イグナイト', noPartsList: [], job: ['03', '06', '12', '14'], exEffect: 'さいだいHP+17 こうげき力+10 特技のダメージ+15 受けるダメージを5軽減する 行動時5%スカラ'},
    {id: '053', level: 120, name: '乱破', noPartsList: [], job: ['04', '08', '13', '20'], exEffect: 'さいだいHP+15 きようさ+80 移動速度+3% 必殺チャージ率+1% 特技のダメージ+20(試合無効)'},
    {id: '054', level: 120, name: 'プロディト', noPartsList: [], job: ['05', '09', '11', '14', '17'], exEffect: 'さいだいHP+14 さいだいMP+12 きようさ+60 呪文と特技の回復+30% 呪文と特技の効果範囲+1m'},
    {id: '055', level: 120, name: 'オスクトル', noPartsList: [], job: ['01', '02', '10', '15', '16', '18'], exEffect: 'さいだいHP+10 さいだいMP+17 雷ダメージ20%減 闇ダメージ20%減 呪文発動速度+2%'},
